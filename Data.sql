...
CONSTRAINT FK_TM_T FOREIGN KEY (M_IDTEAM) REFERENCES TEAM(T_ID)
GO 
ALTER TABLE FMATCH ADD
CONSTRAINT FK_FM_T1 FOREIGN KEY (M_IDTEAM1) REFERENCES TEAM(T_ID),
CONSTRAINT FK_FM_T2 FOREIGN KEY (M_IDTEAM2) REFERENCES TEAM(T_ID)
GO 
ALTER TABLE BET ADD
CONSTRAINT FK_B_AC FOREIGN KEY (B_IDACCOUNT) REFERENCES ACCOUNT(AC_ID),
CONSTRAINT FK_B_FM FOREIGN KEY (B_IDMATCH) REFERENCES FMATCH(M_ID), 
CONSTRAINT FK_B_T FOREIGN KEY (B_IDTEAM) REFERENCES TEAM(T_ID)
GO
ALTER TABLE LETTER ADD
CONSTRAINT FK_L_AC FOREIGN KEY (L_IDACCOUNT) REFERENCES ACCOUNT(AC_ID)
GO 
...
--UPDATE ACCOUNT SET AC_COIN+=100 WHERE AC_ID=9
--SELECT * FROM ACCOUNT
--EXEC RESET_ALL
