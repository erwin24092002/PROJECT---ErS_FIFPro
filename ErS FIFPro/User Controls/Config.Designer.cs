namespace ErS_FIFPro.User_Controls
{
    partial class Config
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Batch Video Link";
